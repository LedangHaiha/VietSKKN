...
export const generateFullSKKNContent = async (project: SKKNProject): Promise<SKKNSection[]> => {
  ...
  const pTeacher = project.teacherName;
      ...
      subSections: [
        {
          ...
          content: `Trong bối cảnh toàn ngành Giáo dục đang tích cực triển khai Chương trình Giáo dục phổ thông 2018 (GDPT 2018) ban hành kèm theo Thông tư 32/2018/TT-BGDĐT, việc chuyển đổi phương thức dạy học từ truyền thụ tri thức đơn thuần sang phát triển phẩm chất và năng lực người học là định hướng chiến lược. Môn ${pSub} (${pGrade}) giữ vị trí trung tâm trong việc hình thành năng lực ngôn ngữ, tư duy phản biện và giải quyết vấn đề cho học sinh.\n\n` +
            `Tuy nhiên, qua thực tiễn giảng dạy tại ${pSchool}, việc tiếp thu kiến thức của học sinh vẫn còn thụ động. Học sinh chủ yếu ghi nhớ máy móc, thiếu phương pháp tự học và chưa chủ động ứng dụng công nghệ thông tin vào việc tra cứu học liệu. Thực trạng này đặt ra yêu cầu cấp thiết phải có giải pháp đột phá kết hợp ứng dụng chuyển đổi số và sơ đồ tư duy đa tương tác.\n\n` +
            `Quán triệt sâu sắc tinh thần Nghị định 30/2020/NĐ-CP về công tác văn thư hành chính và Công văn 3330/SGDĐT-GDTrH về hướng dẫn đánh giá SKKN, tác giả quyết định nghiên cứu và thực nghiệm đề tài: "${pTitle}".`
        },
        {
          id: 'sub-f-1-2',
          ...
          content: `* Mục tiêu chung:\n` +
            ...
            `* Các mục tiêu cụ thể:\n` +
            `1. Đề xuất hệ thống 4 giải pháp đổi mới phương pháp dạy học tích hợp sơ đồ tư duy đa tương tác và mã QR Code học liệu số.\n` +
            `2. Thiết kế bộ công cụ thực nghiệm gồm Phiếu học tập, Bài kiểm tra đánh giá năng lực và Rubric chấm sản phẩm.\n` +
            `3. Đánh giá tính khả thi và đo lường sự tăng trưởng năng lực của học sinh bằng phép kiểm định thống kê toán học Paired T-Test.`
        },
        {
          id: 'sub-f-1-3',
          subNumbering: '3. Phạm vi nghiên cứu',
          title: 'Phạm vi nghiên cứu',
          content: `- Đối tượng nghiên cứu: Biện pháp nâng cao năng lực tự học và giải quyết vấn đề cho học sinh thông qua sơ đồ tư duy đa tương tác và kho học liệu số.\n` +
      ...
      subSections: [
        {
          ...
          content: `Theo Thuyết Kiến tạo trong giáo dục (Piaget, Vygotsky), tri thức được hình thành hiệu quả nhất khi người học tự mình chủ động khám phá và tổ chức lại thông tin. Sơ đồ tư duy (Mind Map) của Tony Buzan kết hợp mã QR Code tương tác giúp kích thích hai bán cầu não, biến các khái niệm phức tạp thành mạng lưới hình ảnh trực quan.\n\n` +
            ...
            `- Công văn 3330/SGDĐT-GDTrH về tiêu chí đánh giá tính mới và hiệu quả SKKN.`
        },
        {
          id: 'sub-f-2-2',
          ...
          content: `Khảo sát thực trạng trước khi áp dụng sáng kiến tại ${pSchool} trên 80 học sinh thu được số liệu:\n` +
            ...
            `- Nguyên nhân do phương pháp dạy học cũ chưa gắn liền với chuyển đổi số và công cụ tương tác hiện đại.`
        }
      ]
    },
    {
      ...
      subSections: [
        {
          ...
          content: `HỆ THỐNG 4 GIẢI PHÁP ĐỘT PHÁ CẢI TIẾN:\n\n` +
            ...
            `🔹 GIẢI PHÁP 4: Xây dựng Bộ Rubric tự đánh giá và đánh giá chéo định hướng sản phẩm học tập.\n\n` +
